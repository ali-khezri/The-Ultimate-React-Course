...
const summary = `${title}, a ${pages}-page long bood, was written by ${author} and published in ${getYear(
  publicationDate
...
const booksAfterUpdate = booksAfterDelete.map((book) =>
  book.id === 1 ? { ...book, pages: 116445548 } : book
);
booksAfterUpdate;
*/
